/* $Id: treflex60.c 1617 2005-11-03 17:41:39Z laforge $ */
...
#ifndef READER_TYPE
#define READER_TYPE SC_READER_REFLEX60
#endif /* READER_TYPE */
#ifndef READER_SLOT
...
int main( int argc, char *argv[] )
{
	...
	ri = scGeneralNewReader( SC_READER_REFLEX60, 1 );
	...
	if( ret==0 ) {
		if( ri->minor==SC_REFLEX60_REFLEX60 ) printf(" Reflex 60\n");
		if( ri->minor==SC_REFLEX60_REFLEX62 ) printf(" Reflex 62\n");
		if( ri->minor==SC_REFLEX60_REFLEX64 ) printf(" Reflex 64\n");
		else printf(" Unkown.\n");
	} else { printf(" Error.\n"); goto exit; }
