/* $Id: tdumbmouse.c 1617 2005-11-03 17:41:39Z laforge $ */
...
int main( int argc, char *argv[] )
{
	...
	ri = scGeneralNewReader( SC_READER_DUMBMOUSE, 1 );
	...
	if( ret==0 ) {
		if( ri->minor==SC_DUMBMOUSE_DUMBMOUSE ) printf(" Dumb Mouse\n");
		else if( ri->minor==SC_DUMBMOUSE_UNIPROG ) printf(" UniProg\n");
		else if( ri->minor==SC_DUMBMOUSE_PHOENIX ) printf(" Phoenix\n");
		else printf(" Unkown.\n");
	} else { printf(" Error.\n"); goto exit; }
