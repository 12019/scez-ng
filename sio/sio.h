...
/* $Id: sio.h 875 2000-09-01 15:31:27Z zwiebeltu $ */

#ifndef HEADER_SIO_TJH_H
#define HEADER_SIO_TJH_H

/* we need this to know if we should be supporting stdio interfaces */
#include "platform.h"    

/* we now depend on having the logging layer available */
#include "slog.h"
